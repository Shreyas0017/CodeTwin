...
export const SessionCreateCommand = cmd({
  ...
  handler: async (args) => {
    await bootstrap(process.cwd(), async () => {
      ...
      UI.println(UI.Style.TEXT_SUCCESS_BOLD + "Session created" + UI.Style.TEXT_NORMAL)
      UI.println(`ID: ${session.id}`)
    })
  },
})
...
export const SessionForkCommand = cmd({
  ...
  handler: async (args) => {
    await bootstrap(process.cwd(), async () => {
      ...
      UI.println(UI.Style.TEXT_SUCCESS_BOLD + "Session forked" + UI.Style.TEXT_NORMAL)
      UI.println(`ID: ${forked.id}`)
      UI.println(`Parent: ${args.sessionID}`)
    })
  },
})
