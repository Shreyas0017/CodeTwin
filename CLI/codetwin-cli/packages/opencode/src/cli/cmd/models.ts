    ...
    await Instance.provide({
      ...
      async fn() {
        ...
        const providerIDs = Object.keys(providers).sort((a, b) => {
          const aIsCodetwin = a.startsWith("codetwin") || a.startsWith("opencode")
          const bIsCodetwin = b.startsWith("codetwin") || b.startsWith("opencode")
          if (aIsCodetwin && !bIsCodetwin) return -1
          if (!aIsCodetwin && bIsCodetwin) return 1
